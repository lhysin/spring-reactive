...
public interface PointRepository extends ReactiveMongoRepository<Point, String> {
    ...
    Flux<Point> findByUserIdAndExpiredAtGreaterThanOrderByCreatedAtDesc(String userId, LocalDateTime now, Pageable pageable);

    Flux<Point> findByUserIdAndCompleteIsFalseAndExpiredAtGreaterThanOrderByCreatedAtAsc(String userId, LocalDateTime now, Pageable pageable);
    ...
    Flux<Point> findByUserIdAndCompleteIsFalseAndExpiredAtGreaterThan(String userId, LocalDateTime now, Pageable pageable);
